...
@section('content')
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        FORMULARIO DE REGISTRO DE MENSAJE AL COMITE
                ...
                <div class="body">
                    ...
                    <form id="sign_in" method="POST" action="{{ route('mensaje.CrearRegistro') }}">
                        @csrf
                        <h2 class="card-inside-title">Crear nuevo mensaje</h2>
                        <div class="row clearfix">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input type="text" name="body" class="form-control"
                                            value="{{ old('body') }}" placeholder="Introduce tu mensaje" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-6">
                                <button class="btn btn-block bg-pink waves-effect" type="submit">Registrar Mensaje</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    @include('layauts.vistas',['pagina'=>'mensaje.registrar'])
