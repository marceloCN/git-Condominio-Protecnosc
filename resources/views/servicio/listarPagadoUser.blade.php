...
@section('title', 'Listar todos los servicios del usuario pagado')
...
@section('content')
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        LISTADO DE TODOS TUS SERVICIOS PAGADOS
                    </h2>
    ...
    @if (session('mensaje'))
        {{ session('mensaje') }}
    @endif
    @include('layauts.vistas',['pagina'=>'servicio.listar.user.pagado'])
