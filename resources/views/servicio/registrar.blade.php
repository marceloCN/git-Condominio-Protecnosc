...
@section('content')
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <form id="sign_in" method="POST" action="{{ route('servicio.CrearRegistro') }}">
                        @csrf
                        <h2 class="card-inside-title">Registrar un nuevo servicio publico</h2>
                        <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input type="text" name="nombre" class="form-control" step="any"
                                            value="{{ old('nombre') }}" placeholder="Introduce el nombre del servicio" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input type="number" name="monto" class="form-control"
                                            value="{{ old('monto') }}" placeholder="Introduce el monto del servicio" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="input-group date" id="bs_datepicker_component_container">
                                    ...
                                    @enderror
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="fechaini" value="{{ old('fechaini') }}"
    ...
    @include('layauts.vistas',['pagina'=>'servicio.registrar'])
