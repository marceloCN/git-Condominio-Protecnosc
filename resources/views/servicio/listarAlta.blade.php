...
@section('title', 'Listar todos los servicios Activos')
...
@section('content')
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        LISTADO DE TODOS LOS SERVICIOS ACTIVOS
                    </h2>
                            ...
                            <tbody>
                                @foreach ($servicio_publicos as $servicio_publico)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('servicio.bajaServicio', $servicio_publico->sp_id) }}"> Desactivar Servicio</a> 
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
    ...
    @if (session('mensaje'))
        {{ session('mensaje') }}
    @endif
    @include('layauts.vistas',['pagina'=>'servicio.listar.alta'])
