...
@section('title', 'Registro de Condominio')
...
@section('content')
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        FORMULARIO DE REGISTRO DE UN NUEVO CONDOMINIO
                ...
                <div class="body">
                    ...
                    <form id="sign_in" method="POST" action="{{ route('condominio.CrearRegistro') }}">
                        @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input type="text" name="nombre" class="form-control"
                                            value="{{ old('nombre') }}" placeholder="Introduce el nombre del condominio"
                                            required>
                                    </div>
                                </div>
                            </div>
    ...
    @include('layauts.vistas',['pagina'=>'condominio.registrar'])
